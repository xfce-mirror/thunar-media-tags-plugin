...
thunar_extension_initialize (ThunarxProviderPlugin *plugin)
{
  ...
  thunar_sbr_register_tag_enum_types (plugin);

  /* register the types provided by this plugin */
  thunar_sbr_tag_renamer_provider_register_type (plugin);
  thunar_sbr_tag_renamer_register_type (plugin);

  /* setup the plugin provider type list */
  type_list[0] = THUNAR_SBR_TYPE_TAG_RENAMER_PROVIDER;
}
